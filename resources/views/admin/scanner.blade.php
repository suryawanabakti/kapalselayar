        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl p-6 border border-gray-100">
                    ...
                    <div id="reader" class="rounded-xl overflow-hidden border-4 border-gray-50 bg-gray-50"
                        style="width: 100%"></div>
                ...
                <div class="space-y-6">
                    <div id="result-container"
                        class="bg-white overflow-hidden shadow-xl sm:rounded-2xl p-8 border border-gray-100 hidden">
                        <div id="result-content">
                            ...
                            <button onclick="resetScanner()"
                                class="mt-8 w-full bg-gray-100 hover:bg-gray-200 text-gray-900 font-bold py-3 rounded-xl transition">
                                Scan Berikutnya
                            </button>
                        </div>
                    </div>
                    ...
                    <div id="placeholder-container"
                        class="bg-white overflow-hidden shadow-md sm:rounded-2xl p-8 border border-gray-100 flex flex-col items-center justify-center text-center py-20">
