                                            ...
                                            @foreach ($order->passengers as $passenger)
                                                <div class="flex items-center justify-between bg-gray-50 p-3 rounded-xl border border-gray-100">
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <p class="font-semibold text-gray-900 text-sm">{{ $passenger->name }}</p>
                                                            <p class="text-xs text-gray-500">{{ $passenger->nik }}</p>
                                                        </div>
                                                    </div>
                                                    @if ($order->status === 'paid')
                                                        <a href="{{ route('user.transactions.ticket', $passenger->ticket_code) }}" 
                                                           class="bg-white border border-gray-200 hover:border-blue-500 hover:text-blue-600 text-gray-700 px-4 py-2 rounded-lg text-xs font-bold transition flex items-center gap-2 shadow-sm">
